...
late final List<ui.FlutterView> views;

void beginFrame(Duration timeStamp) {
  final double devicePixelRatio = views.first.devicePixelRatio;
  final ui.Size logicalSize = views.first.physicalSize / devicePixelRatio;
  ...
  for (final view in views) {
    // Both scenes and scene builders cannot be reused to render multiple views.
...
void main() {
  ...
  views = ui.PlatformDispatcher.instance.views.toList();
